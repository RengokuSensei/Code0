...
<div class="aa-grid">
  ...
  <a href="about/author/" class="aa-card">
    <span class="aa-card-icon">🚀</span>
    <div class="aa-card-title">Author & Community</div>
    <p class="aa-card-desc">Connect with Aditya, subscribe on YouTube, and join discussions on Instagram.</p>
  </a>
</div>
...
=== "💡 What We Cover"
    ...
    - **Chemistry & Atomic Structures**: Interactive electronic shell visualizations and orbital models.
...
=== "🔗 Stay Connected"
    Subscribe to the official channels for regular breakdowns and video guides:
...
!!! tip "Quick Start"
    To customize content on this site, edit the Markdown files located inside the `docs/` folder. Changes update in real-time when running your local development server.
